...
export class ExternalSocketIoAdapter extends AbstractWsAdapter {
  constructor(app?: INestApplicationContext, private readonly cors: string | string[] = '*') {
    super(app);
  }
  ...
  public bindMessageHandlers(client: any, handlers: MessageMappingProperties[], transform: any) {
